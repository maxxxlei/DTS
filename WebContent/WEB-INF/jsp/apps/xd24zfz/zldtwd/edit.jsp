    ...
    <div>
          <form id="myfrm" name="myfrm" align="center" method="post">
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="margin_lr_10 margin_t_10" align="center" width="400">
                <br>
              <tr>
                <th width="90px"><font color="red">*</font><label class="margin_r_10" for="text">战略地图名称:</label></th>
                <td>
                  <div><!--     readonly unselectable="on"
                    ...
                    <input type="text" id="mapName" class="validate" validate="type:'string',name:'战略地图名称',notNull:true,maxLength:50,avoidChar:'!@#$%^&amp;*+|,'" style="width:300px"/>
                </td>
              </tr>
              <tr>
